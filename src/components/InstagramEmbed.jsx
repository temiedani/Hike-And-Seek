  ...
  const setSampleEmbedData = () => {
    setPosts([
      ...
      },
      {
        ...
        embedCode: null, // Will use placeholder
        title: "Box Hill Surrey Adventure",
